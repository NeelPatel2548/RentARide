        ...
        <div class="dashboard-container">
            ...
            <div class="dashboard-content">
                ...
                <div class="history-container">
                    ...
                    $userId = $_SESSION['forCar'];
                    // Prepare and execute the query
                    $stmt = $conn->prepare("SELECT 
                b.b_id,
                b.c_id,
                b.v_id,
                COALESCE(c.car_name, b1.bike_name) AS vehicle_model,
                COALESCE(c.car_brand, b1.bike_brand) AS vehicle_color,
                COALESCE(c.car_trans, b1.bike_type) AS vehicle_type,
                COALESCE(c.car_fuel, b1.bike_fuel) AS fuel,
                COALESCE(c.car_price, b1.bike_price) AS price,
                COALESCE(c.car_no, b1.bike_no) AS vehicle_no
            FROM 
                booking b
            LEFT JOIN car c ON b.v_id = c.car_no
            LEFT JOIN bike b1 ON b.v_id = b1.bike_no
            WHERE b.c_id = ?;");
                    $stmt->bind_param("i", $_SESSION['forCar']);
                    $stmt->execute();
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<thead>";
                        echo "<tr><th>Vehicle Name</th><th>Brand</th><th>Vehicle Type</th><th>Fuel</th><th>Price</th><th>Vehicle No</th></tr>";
                        echo "</thead>";
                        echo "<tbody>";
