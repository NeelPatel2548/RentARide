...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmtCheckMail = $conn->prepare("SELECT * FROM user WHERE email = ?");
    ...
    if ($resultCheckMail->num_rows > 0) {
        ...
        if ($password == $repass) {
            ...
            $sql = "INSERT INTO user (user_name, user_id, email, contact, address, user_state, user_city, user_aadhr, user_pass, user_profile, user_license) VALUES ('$name','$user_id', '$email', '$contact', '$address', '$state', '$city', '$aadhar', '$password', '$profile_photo_path', '$driving_license_photo_path')";
...
<body>
    ...
    <nav class="nav" id="mainNav">
        <ul class="nav-list">
            ...
            <li class="nav-item"><a href="signup.php" class="nav-link active"><i class="fas fa-user-plus"></i>Sign Up</a></li>
        ...
        <div class="signup-container">
            ...
            <form class="signup-form" action="signup.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-footer">
                    ...
                    <p>Looking to register as a rental agent? <a href="rental_agent_signup.php">Rental Agent Signup</a></p>
                </div>
            </form>
        </div>
    </main>
