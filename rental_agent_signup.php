...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email = $_POST['email'];
    $agent_id = "rentalagent@" . $contact;

    $stmtCheckMail = $conn->prepare("SELECT * FROM rental_agent WHERE agent_email = ?");
    ...
    if ($resultCheckMail->num_rows > 0) {
        ...
        if ($password == $repass) {
            ...
            $sql = "INSERT INTO rental_agent (agent_name, agent_id, agent_email, agent_contact, agent_address, agent_state, agent_city, agent_aadhr, agent_pass, agent_profile) VALUES ('$name','$agent_id', '$email', '$contact', '$address', '$state', '$city', '$aadhar', '$password', '$profile_photo_path')";

            if ($conn->query($sql) === TRUE) {
                echo "<script>alert('Agent account created successfully');
...
<head>
    ...
    <title>RentARide - Rental Agent Sign Up</title>
...
<body>
    ...
    <nav class="nav" id="mainNav">
        <ul class="nav-list">
            ...
            <li class="nav-item"><a href="signup.php" class="nav-link"><i class="fas fa-user-plus"></i>Sign Up</a></li>
            <li class="nav-item"><a href="rental_agent_signup.php" class="nav-link active"><i class="fas fa-id-card"></i>Agent Sign Up</a></li>
    ...
    <main class="main-content">
        <div class="signup-container">
            <div class="signup-header">
                <h2>Create Rental Agent Account</h2>
                <p>Please fill in the details to create your agent account.</p>
            </div>
            ...
            <?php endif; ?>
            <form class="signup-form" action="rental_agent_signup.php" method="post" enctype="multipart/form-data">
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="aadhar"><i class="fas fa-id-badge"></i>Aadhar Card No.</label>
                ...
                <button type="submit" class="signup-btn"><i class="fas fa-id-card"></i> Create Agent Account</button>
                <div class="form-footer">
                    <p>Already have an account? <a href="login.php">Log in</a></p>
                    <p>Looking for a user account? <a href="signup.php">Sign up as User</a></p>
                </div>
            </form>
        </div>
    </main>
