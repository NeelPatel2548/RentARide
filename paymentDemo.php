    ...
    <main class="main-content">
        <div class="payment-container">
            <div class="payment-header">
                ...
                <p>You're just one step away from booking your ride!</p>
            </div>
            <div class="payment-body">
                ...
                <div class="order-summary">
                    ...
                    <?php if(isset($_SESSION['selected_car'])): ?>
                        <div class="car-details">
                     
                            <div class="car-info">
                                <p><strong>Car Name:</strong><?php echo $_SESSION['selected_car']['car_name']; ?></p>
                                <p><strong>Brand:</strong> <?php echo $_SESSION['selected_car']['car_brand']; ?></p>
                               
                                <p><strong>Fuel:</strong> <?php echo $_SESSION['selected_car']['car_fuel']; ?></p>
                                <p><strong>Price per day:</strong> ₹<?php echo $_SESSION['selected_car']['car_price']; ?></p>
                            </div>
                        </div>
                        <?php if(isset($_SESSION['booking_details'])): ?>
                            <div class="booking-details">
                                ...
                                <?php 
                                $total_amount = $_SESSION['selected_car']['car_price'] * $_SESSION['booking_details']['total_days'];
                                ?>
